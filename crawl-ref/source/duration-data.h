...
static const duration_def duration_data[] =
{
    ...
    { DUR_PACK_COOLDOWN,
      ...
      "", "pack cooldown",
      "", D_NO_FLAGS,
      {{ "You feel ready to call your pack again." }}},
    { DUR_OBSIDIAN_EDGE,
      LIGHTMAGENTA, "Obsidian",
      "obsidian-edged", "obsidian edge",
      "Tonalli has edged your blows with obsidian.", D_EXPIRES,
      {{ "Your obsidian edge crumbles away." }, { "Your obsidian edge is dulling.", 1 }}, 5},
    { DUR_WAR_PAINT,
      LIGHTRED, "WarPaint",
