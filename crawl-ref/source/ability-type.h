...
enum ability_type
{
    ...
    ABIL_ELYVILON_PACIFY,
    ABIL_ELYVILON_AURA_OF_VIGOUR,
    ABIL_ELYVILON_DIVINE_ALMS,
    // Lugonu
    ...
    // Vashtar
    ABIL_VASHTAR_WAR_PAINT = 1310,
    ABIL_VASHTAR_FURY,
    ABIL_VASHTAR_BLOOD_TITHE,
    ABIL_VASHTAR_SPOILS_OF_WAR,
    ABIL_VASHTAR_THOUSAND_ARMS,
    // Tonalli
    ABIL_TONALLI_OBSIDIAN_EDGE = 1320,
    ABIL_TONALLI_SUN_LANCE,
    ABIL_TONALLI_FEATHERED_SERPENT,
    ABIL_TONALLI_HEART_OFFERING,

#if TAG_MAJOR_VERSION == 34
    ABIL_STOP_RECALL = 1500,
    ABIL_LAST_RELIGIOUS_ABILITY = ABIL_STOP_RECALL,
#else
    ABIL_LAST_RELIGIOUS_ABILITY = ABIL_TONALLI_HEART_OFFERING,
#endif
